...
export default function EquipoForm() {
  ...
  const [tipoDispositivo, setTipoDispositivo] = useState<number>(1);
 ...
 const renderLaptopFields = () => (
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
      ...
      <Select onValueChange={value => handleChange("almacenamiento_id", value)}>
        <SelectTrigger>
    ...
    {formData.pertenece === "ALQUILER" && (
      <div>
        ...
        <Select onValueChange={value => handleChange("empresa_alquiler_id", value)}>
          <SelectTrigger>
  ...
  <div className="w-full min-h-screen flex items-center justify-center p-6 bg-gray-50">
    <Card className="w-full max-w-5xl">
        ...
        <div>
          ...
          <Select 
            ...
            >
              ...
              <SelectContent>
                {Array.isArray(catalogo.tiposDispositivo) && catalogo.tiposDispositivo.map((item: any) => (
                  <SelectItem key={item.value} value={item.value.toString()}>
                    {item.label}
                  </SelectItem>
                ))}
      ...
      <CardFooter className="flex justify-end gap-2">
        ...
        <Button onClick={handleEliminar} variant="destructive">Eliminar</Button>
      </CardFooter>
